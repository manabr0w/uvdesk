...
class __TwigTemplate_19ed7b0eb82ec9c8c0804928012773c1 extends Template
{
...
\t\t\t\t\t";
        // line 37
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["user_service"]) || array_key_exists("user_service", $context) ? $context["user_service"] : (function () { throw new RuntimeError('Variable "user_service" does not exist.', 37, $this->source); })()), "isAccessAuthorized", ["email_templates_add_action"], "method", false, false, false, 37)) {
            // line 38
            yield "\t\t\t\t\t\t<a href=\"";
...
\t</script>
{% endblock %}
", "@UVDeskCoreFramework/templateList.html.twig", "/home/maksim/Desktop/uvdesk/vendor/uvdesk/core-framework/Resources/views/templateList.html.twig");
    }
}
