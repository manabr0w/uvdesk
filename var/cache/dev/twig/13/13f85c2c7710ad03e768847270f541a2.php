...
class __TwigTemplate_6054f508156eb671e6a817c634736c3c extends Template
{
...
\t\t";
        ...
        if ( !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 155, $this->source); })()), "request", [], "any", false, false, false, 155), "get", ["id"], "method", false, false, false, 155))) {
...
{% endblock %}
", "@UVDeskAutomation/Workflow/editWorkflow.html.twig", "/home/maksim/Desktop/uvdesk/vendor/uvdesk/automation-bundle/Resources/views/Workflow/editWorkflow.html.twig");
    }
}
